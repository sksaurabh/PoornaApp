...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int MULTIPLE_PERMISSIONS = 211;
    Helper helper;
    ArrayList<ContactNumberBean> mcontactNumberBean;
    String name,phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mcontactNumberBean=new ArrayList<>();
                ...
                if (Integer.parseInt(cur.getString(cur.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))) > 0) {
                    ...
                    while (pCur.moveToNext()) {
                        ...
                        Log.e("number",""+phone);
                            ...
                            contactNumberBean.setmName(name);
                            contactNumberBean.setmNumber(phone);
                        mcontactNumberBean.add(contactNumberBean);
    ...
    private void InsertEventDetails() {
               helper.openDataBase();
        helper.insertEventsoffers(mcontactNumberBean);
